    ...
    protected function filter($queryBuilder, Request $request)
    {
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has('EventControllerFilter')) {
                ...
                $filterForm = $this->createForm('AdminBundle\Form\EventFilterType', $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $editLink = $this->generateUrl('AdminEvent_edit', array('id' => $event->getId()));
            $this->get('session')->getFlashBag()->add('success', "<a href='$editLink'>New event was created successfully.</a>" );
            
            $nextAction=  $request->get('submit') == 'save' ? 'AdminEvent' : 'AdminEvent_new';
     ...
     *
     * @Route("/{id}/edit", name="AdminEvent_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Event $event)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('AdminEvent_edit', array('id' => $event->getId()));
        }
        return $this->render('@Admin/event/edit.html.twig', array(
            'event' => $event,
            'AdminEdit_form' => $editForm->createView(),
            'AdminDelete_form' => $deleteForm->createView(),
        ));
    }
     ...
     *
     * @Route("/{id}", name="AdminEvent_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Event $event)
    {
        ...
        return $this->redirectToRoute('AdminEvent');
    }
    ...
    private function createDeleteForm(Event $event)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('AdminEvent_delete', array('id' => $event->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
     ...
     * Delete Event by id
     *
     * @Route("/delete/{id}", name="AdminEvent_by_id_delete")
     * @Method("GET")
     */
    public function deleteByIdAction(Event $event){
        ...
        return $this->redirect($this->generateUrl('AdminEvent'));
    ...
    /**
    * Bulk Action
    * @Route("/bulk-action/", name="AdminEvent_bulk_action")
    * @Method("POST")
    */
