...
class ThemeController extends Controller
{
    ...
    */
    protected function filter($queryBuilder, Request $request)
    {
        ...
        $filterForm = $this->createForm('AdminBundle\Form\ThemeFilterType');
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has('ThemeControllerFilter')) {
                ...
                $filterForm = $this->createForm('AdminBundle\Form\ThemeFilterType', $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder, Request $request)
    {
        ...
        $routeGenerator = function($page) use ($me, $request)
        {
            ...
            return $me->generateUrl('theme', $requestParams);
        };
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $editLink = $this->generateUrl('theme_edit', array('id' => $theme->getId()));
        ...
        return $this->render('@Admin/theme/new.html.twig', array(
            'theme' => $theme,
    ...
    public function showAction(Theme $theme)
    {
        ...
        return $this->render('@Admin/theme/show.html.twig', array(
            'theme' => $theme,
