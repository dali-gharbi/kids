...
class VaccineController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('@Admin/vaccine/index.html.twig', array(
            'vaccines' => $vaccines,
            'pagerHtml' => $pagerHtml,
    ...
    */
    ...
    {
        $filterForm = $this->createForm('AdminBundle\Form\VaccineFilterType');
    ...
    */
    protected function paginator($queryBuilder, Request $request)
    {
        ...
        $routeGenerator = function($page) use ($me, $request)
        {
            ...
            return $me->generateUrl('vaccines', $requestParams);
        };
    ...
    public function newAction(Request $request)
    {
        ...
        $vaccine = new Vaccine();
        $form   = $this->createForm('AdminBundle\Form\VaccineType', $vaccine);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $nextAction=  $request->get('submit') == 'save' ? 'vaccines' : 'vaccines_new';
            return $this->redirectToRoute($nextAction);
        }
        return $this->render('@Admin/vaccine/new.html.twig', array(
            'vaccine' => $vaccine,
     ...
     *
     * @Route("/{id}/edit", name="vaccine_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Vaccine $vaccine)
    {
        $deleteForm = $this->createDeleteForm($vaccine);
        $editForm = $this->createForm('AdminBundle\Form\VaccineType', $vaccine);
        ...
        return $this->render('@Admin/vaccine/edit.html.twig', array(
            'vaccine' => $vaccine,
     ...
     *
     * @Route("/delete/{id}", name="vaccine_by_id_delete")
     * @Method("GET")
     */
